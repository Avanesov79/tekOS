...
rpm-ostree install neovim pass git jq yq bat fzf ripgrep htop eza stow syncthing ansible hyprland lazygit zellij waybar hyprpaper hyprpicker hyprlock hypridle hyprcursor dunst wev
